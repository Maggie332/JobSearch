...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "eac948fe7ea0d0b853b238d750827967db8ccc1d";
    ...
    public List<Set<String>> extract(List<String> articles) {
        ...
        ExtractRequestBody body = new ExtractRequestBody(articles, 3); //below convert to jsonbody
        ...
        ResponseHandler<List<Set<String>>> responseHandler = response -> {
            ...
            //every article has several keywords. all the articles return the keywordList
